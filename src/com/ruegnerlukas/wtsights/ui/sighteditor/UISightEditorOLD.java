...
//		UISightEditorOLD controller = (UISightEditorOLD)sceneObjects[0];
...
//		
//		try {
//			FXMLLoader loader = new FXMLLoader(UISightEditorOLD.class.getResource("/ui/sightEditor/layout_general.fxml"));
...
//		
//		try {
//			FXMLLoader loader = new FXMLLoader(UISightEditorOLD.class.getResource("/ui/sightEditor/layout_environment.fxml"));
//			Parent root = (Parent) loader.load();
...
//		try {
//			FXMLLoader loader = new FXMLLoader(UISightEditorOLD.class.getResource(path));
//			Parent root = (Parent) loader.load();
//			paneGeneral.getChildren().add(root);
