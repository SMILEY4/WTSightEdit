...
//
//public class ModuleCustomQuadOutline implements Module {
//
//	private ElementCustomQuadOutline element;
//
...
//		ElementCustomQuadOutline elementDefault = new ElementCustomQuadOutline();
//		
...
//			@Override public void changed(ObservableValue<? extends Double> observable, Double oldValue, Double newValue) {
//				System.out.println("POS1X " + element);
//				if(element != null) {
...
//		if(e == null || e.type != ElementType.CUSTOM_QUAD_OUTLINE) {
//			this.element = null;
//		} else {
//			this.element = (ElementCustomQuadOutline)e;
//		}
