...
public class ModuleBallisticRangeIndicators implements Module {

	private ElementBallRangeIndicator element;
	...
	public void setElement(BaseElement e) {
		...
		if(e == null || e.type != ElementType.BALLISTIC_RANGE_INDICATORS) {
			this.element = null;
		} else {
			this.element = (ElementBallRangeIndicator)e;
		}
