			...
			@Override public void handle(ActionEvent event) {
				if(element != null) {
					...
					if(element.useThousandth) {
						FXUtils.initSpinner(spinnerStartX, Conversion.get().screenspace2mil(spinnerStartX.getValue(), data.dataSight.envZoomedIn), Integer.MIN_VALUE, Integer.MAX_VALUE, 0.5, 1, null);
						FXUtils.initSpinner(spinnerStartY, Conversion.get().screenspace2mil(spinnerStartY.getValue(), data.dataSight.envZoomedIn), Integer.MIN_VALUE, Integer.MAX_VALUE, 0.5, 1, null);
						FXUtils.initSpinner(spinnerEndX, Conversion.get().screenspace2mil(spinnerEndX.getValue(), data.dataSight.envZoomedIn), Integer.MIN_VALUE, Integer.MAX_VALUE, 0.5, 1, null);
						FXUtils.initSpinner(spinnerEndY, Conversion.get().screenspace2mil(spinnerEndY.getValue(), data.dataSight.envZoomedIn), Integer.MIN_VALUE, Integer.MAX_VALUE, 0.5, 1, null);
					} else {
						FXUtils.initSpinner(spinnerStartX, Conversion.get().mil2screenspace(spinnerStartX.getValue(), data.dataSight.envZoomedIn), Integer.MIN_VALUE, Integer.MAX_VALUE, 0.01, 2, null);
						FXUtils.initSpinner(spinnerStartY, Conversion.get().mil2screenspace(spinnerStartY.getValue(), data.dataSight.envZoomedIn), Integer.MIN_VALUE, Integer.MAX_VALUE, 0.01, 2, null);
