...
public enum ElementType {
	...
	CUSTOM_CIRCLE_FILLED		(ViewManager.getResources().getString("et_custom_circle_filled"),		8, 0, 9999),
	CUSTOM_QUAD_OUTLINE			(ViewManager.getResources().getString("et_custom_quad_outline"),		9, 0, 9999),
	CUSTOM_QUAD_FILLED			(ViewManager.getResources().getString("et_custom_quad_filled"),			10, 0, 9999),
	...
	FUNNEL						(ViewManager.getResources().getString("et_funnel"),						14, 0, 9999),
	;
