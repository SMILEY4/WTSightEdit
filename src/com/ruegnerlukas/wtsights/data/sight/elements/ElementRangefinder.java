...
public class ElementRangefinder extends Element {
	...
	public Color 		color1 		= new Color(0/255f, 255/255f, 0/255f, 64/255f);		// color of the progress bar
	public Color 		color2 		= new Color(255/255f, 255/255f, 255/255f, 64/255f);	// color of the background
